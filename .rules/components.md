...
| `mentor/`    | `MentorBubble`, `Typewriter`, `ThinkingIndicator`, `SocratesGlyph`, `ModelStatusBadge`, `LocalModelPanel`                                                                                 |
| `review/`    | `ReviewMode`                                                                                                                                                                              |
...
| `MentorBubble`            | Slide-up Socratic chat **sheet** above the `StatusBar` (no FAB; entry lives in `StatusBar`); dodges the inspector; `mentorPanelExpanded` persisted; header **New chat** (reload). See [mentor](mentor.md).                                                   |
| `SocratesGlyph`           | SVG avatar for the mentor (status-bar entry with breathing halo, sheet header, review).                                                                                                                                                                      |
| `ReviewMode`              | Full-screen FSRS review; queues due nodes; Again/Hard/Good/Easy → `recordStudyRating`.                                                                                                                                                                       |
| `SettingsDialog`          | Tabbed modal: Appearance, AI, Review (FSRS). Opened via ⌘,.                                                                                                                                                                                                  |
