...
- **AI feature documentation must state** what graph and chat content leaves the device, whether context is eager or on demand, where it is sent, and whether tool traces and history persist.
