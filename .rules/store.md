...
| `ui.ts`               | Sidebar chrome, `mentorPanelExpanded`, `viewports`, `saveViewport`                                                                                                                                                   |
...
| `setSidebarCollapsed` / `setSidebarDisplayOpen` / `setSidebarStatsOpen` | Sidebar chrome toggles (persisted)                                                                                                                          |
