...
const en = {
  ...
  writing: {
    ...
    snippets: {
      ...
      heading3: 'Heading 3',
      heading3Desc: 'Subsection title',
      bulletList: 'Bullet list',
      bulletListDesc: 'Unordered list',
      orderedList: 'Numbered list',
      orderedListDesc: 'Ordered list',
      blockquote: 'Quote',
  ...
  sidebar: {
    ...
    projectSwitcher: {
      ...
      projects: 'Projects',
      openOrCreateProject: 'Add project…',
      openOrCreateProjectShort: 'Add',
  ...
  menu: {
    ...
    settings: 'Settings…',
    newGraph: 'New Graph',
    openOrCreateProject: 'Open or Create Project…',
