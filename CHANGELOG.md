...
- **Single hover connection dot:** hovering a concept shows the shared dashed outline plus one connection dot fixed on the top-left of its border, replacing the two fixed side dots. Drag from the dot to create a relation.
